...
def modules(symbol):
        ...
        if response.status_code == 200:
                ...
                def incomeStatementHistoryQuarterly():
                ...
                def cashflowStatementHistoryQuarterly():
                        # get cashflowStatementHistoryQuarterly
                        quarterlyCashflow_list = []
                        cashflowStatementHistoryQuarterly = response_data.get("cashflowStatementHistoryQuarterly", {}).get("cashflowStatements", "N/A")
                        for quarterlyCashflow in cashflowStatementHistoryQuarterly:
                                endDate = quarterlyCashflow.get("endDate", {}).get("raw", "N/A")
                                endDate_fmt = quarterlyCashflow.get("endDate", {}).get("fmt", "N/A")
                                netIncome = quarterlyCashflow.get("netIncome", {}).get("raw", "N/A")
                                netIncome_fmt = quarterlyCashflow.get("netIncome", {}).get("fmt", "N/A")
                                netIncome_long = quarterlyCashflow.get("netIncome", {}).get("longFmt", "N/A")
                                depreciation = quarterlyCashflow.get("depreciation", {}).get("raw", "N/A")
                                depreciation_fmt = quarterlyCashflow.get("depreciation", {}).get("fmt", "N/A")
                                depreciation_long = quarterlyCashflow.get("depreciation", {}).get("longFmt", "N/A")
                                changeToNetIncome = quarterlyCashflow.get("changeToNetIncome", {}).get("raw", "N/A")
                                changeToNetIncome_fmt = quarterlyCashflow.get("changeToNetIncome", {}).get("fmt", "N/A")
                                changeToNetIncome_long = quarterlyCashflow.get("changeToNetIncome", {}).get("longFmt", "N/A")
                                changeToAccountReceivables = quarterlyCashflow.get("changeToAccountReceivables", {}).get("raw", "N/A")
                                changeToAccountReceivables_fmt = quarterlyCashflow.get("changeToAccountReceivables", {}).get("fmt", "N/A")
                                changeToAccountReceivables_long = quarterlyCashflow.get("changeToAccountReceivables", {}).get("longFmt", "N/A")
                                changeToLiabilities = quarterlyCashflow.get("changeToLiabilities", {}).get("raw", "N/A")
                                changeToLiabilities_fmt = quarterlyCashflow.get("changeToLiabilities", {}).get("fmt", "N/A")
                                changeToLiabilities_long = quarterlyCashflow.get("changeToLiabilities", {}).get("longFmt", "N/A")
                                changeToInventory = quarterlyCashflow.get("changeToInventory", {}).get("raw", "N/A")
                                changeToInventory_fmt = quarterlyCashflow.get("changeToInventory", {}).get("fmt", "N/A")
                                changeToInventory_long = quarterlyCashflow.get("changeToInventory", {}).get("longFmt", "N/A")
                                changeToOperatingActivities = quarterlyCashflow.get("changeToOperatingActivities", {}).get("raw", "N/A")
                                changeToOperatingActivities_fmt = quarterlyCashflow.get("changeToOperatingActivities", {}).get("fmt", "N/A")
                                changeToOperatingActivities_long = quarterlyCashflow.get("changeToOperatingActivities", {}).get("longFmt", "N/A")
                                totalCashFromOperatingActivities = quarterlyCashflow.get("totalCashFromOperatingActivities", {}).get("raw", "N/A")
                                totalCashFromOperatingActivities_fmt = quarterlyCashflow.get("totalCashFromOperatingActivities", {}).get("fmt", "N/A")
                                totalCashFromOperatingActivities_long = quarterlyCashflow.get("totalCashFromOperatingActivities", {}).get("longFmt", "N/A")
                                capitalExpenditures = quarterlyCashflow.get("capitalExpenditures", {}).get("raw", "N/A")
                                capitalExpenditures_fmt = quarterlyCashflow.get("capitalExpenditures", {}).get("fmt", "N/A")
                                capitalExpenditures_long = quarterlyCashflow.get("capitalExpenditures", {}).get("longFmt", "N/A")
                                investments = quarterlyCashflow.get("investments", {}).get("raw", "N/A")
                                investments_fmt = quarterlyCashflow.get("investments", {}).get("fmt", "N/A")
                                investments_long = quarterlyCashflow.get("investments", {}).get("longFmt", "N/A")
                                otherCashflowsFromInvestingActivities = quarterlyCashflow.get("otherCashflowsFromInvestingActivities", {}).get("raw", "N/A")
                                otherCashflowsFromInvestingActivities_fmt = quarterlyCashflow.get("otherCashflowsFromInvestingActivities", {}).get("fmt", "N/A")
                                otherCashflowsFromInvestingActivities_long = quarterlyCashflow.get("otherCashflowsFromInvestingActivities", {}).get("longFmt", "N/A")
                                totalCashflowsFromInvestingActivities = quarterlyCashflow.get("totalCashflowsFromInvestingActivities", {}).get("raw", "N/A")
                                totalCashflowsFromInvestingActivities_fmt = quarterlyCashflow.get("totalCashflowsFromInvestingActivities", {}).get("fmt", "N/A")
                                totalCashflowsFromInvestingActivities_long = quarterlyCashflow.get("totalCashflowsFromInvestingActivities", {}).get("longFmt", "N/A")
                                dividendsPaid = quarterlyCashflow.get("dividendsPaid", {}).get("raw", "N/A")
                                dividendsPaid_fmt = quarterlyCashflow.get("dividendsPaid", {}).get("fmt", "N/A")
                                dividendsPaid_long = quarterlyCashflow.get("dividendsPaid", {}).get("longFmt", "N/A")
                                netBorrowings = quarterlyCashflow.get("netBorrowings", {}).get("raw", "N/A")
                                netBorrowings_fmt = quarterlyCashflow.get("netBorrowings", {}).get("fmt", "N/A")
                                netBorrowings_long = quarterlyCashflow.get("netBorrowings", {}).get("longFmt", "N/A")
                                otherCashflowsFromFinancingActivities = quarterlyCashflow.get("otherCashflowsFromFinancingActivities", {}).get("raw", "N/A")
                                otherCashflowsFromFinancingActivities_fmt = quarterlyCashflow.get("otherCashflowsFromFinancingActivities", {}).get("fmt", "N/A")
                                otherCashflowsFromFinancingActivities_long = quarterlyCashflow.get("otherCashflowsFromFinancingActivities", {}).get("longFmt", "N/A")
                                totalCashFromFinancingActivities = quarterlyCashflow.get("totalCashFromFinancingActivities", {}).get("raw", "N/A")
                                totalCashFromFinancingActivities_fmt = quarterlyCashflow.get("totalCashFromFinancingActivities", {}).get("fmt", "N/A")
                                totalCashFromFinancingActivities_long = quarterlyCashflow.get("totalCashFromFinancingActivities", {}).get("longFmt", "N/A")
                                changeInCash = quarterlyCashflow.get("changeInCash", {}).get("raw", "N/A")
                                changeInCash_fmt = quarterlyCashflow.get("changeInCash", {}).get("fmt", "N/A")
                                changeInCash_long = quarterlyCashflow.get("changeInCash", {}).get("longFmt", "N/A")
                                repurchaseOfStock = quarterlyCashflow.get("repurchaseOfStock", {}).get("raw", "N/A")
                                repurchaseOfStock_fmt = quarterlyCashflow.get("repurchaseOfStock", {}).get("fmt", "N/A")
                                repurchaseOfStock_long = quarterlyCashflow.get("repurchaseOfStock", {}).get("longFmt", "N/A")
                                quarterlyCashflow_data = {"endDate": endDate_fmt, "netIncome": netIncome_fmt, "depreciation": depreciation_fmt, "changeToNetincome": changeToNetIncome_fmt, "changeToAccountReceivables": changeToAccountReceivables_fmt, "changeToLiabilities": changeToLiabilities_fmt, "changeToInventory": changeToInventory_fmt, "changeToOperatingActivities": changeToOperatingActivities_fmt, "totalCashFromOperatingActivities": totalCashFromOperatingActivities_fmt, "capitalExpenditures": capitalExpenditures_fmt, "investments": investments_fmt, "otherCashflowsFromInvestingActivities": otherCashflowsFromInvestingActivities_fmt, "totalCashflowsFromInvestingActivities": totalCashflowsFromInvestingActivities_fmt, "dividendsPaid": dividendsPaid_fmt, "netBorrowings": netBorrowings_fmt, "otherCashflowsFromFinancingActivities": otherCashflowsFromFinancingActivities_fmt, "totalCashFromFinancingActivities": totalCashFromFinancingActivities_fmt, "changeInCash": changeInCash_fmt, "repurchaseOfStock": repurchaseOfStock_fmt}
                                quarterlyCashflow_list.append(quarterlyCashflow_data)
                
                def get_balanceSheetHistoryQuarterly():
                        # get balanceSheetHistoryQuarterly
                        quarterlyBalanceSheet_list = []
                        balanceSheetHistoryQuarterly = response_data.get("balanceSheetHistoryQuarterly", {}).get("balanceSheetStatements", "N/A")
                        for quarterlyBalanceSheet in balanceSheetHistoryQuarterly:
                                endDate = quarterlyBalanceSheet.get("endDate", {}).get("raw", "N/A")
                                endDate_fmt = quarterlyBalanceSheet.get("endDate", {}).get("fmt", "N/A")
                                cash = quarterlyBalanceSheet.get("cash", {}).get("raw", "N/A")
                                cash_fmt = quarterlyBalanceSheet.get("cash", {}).get("fmt", "N/A")
                                cash_long = quarterlyBalanceSheet.get("cash", {}).get("longFmt", "N/A")
                                shortTermInvestments = quarterlyBalanceSheet.get("shortTermInvestments", {}).get("raw", "N/A")
                                shortTermInvestments_fmt = quarterlyBalanceSheet.get("shortTermInvestments", {}).get("fmt", "N/A")
                                shortTermInvestments_long = quarterlyBalanceSheet.get("shortTermInvestments", {}).get("longFmt", "N/A")
                                netReceivables = quarterlyBalanceSheet.get("netReceivables", {}).get("raw", "N/A")
                                netReceivables_fmt = quarterlyBalanceSheet.get("netReceivables", {}).get("fmt", "N/A")
                                netReceivables_long = quarterlyBalanceSheet.get("netReceivables", {}).get("longFmt", "N/A")
                                inventory = quarterlyBalanceSheet.get("inventory", {}).get("raw", "N/A")
                                inventory_fmt = quarterlyBalanceSheet.get("inventory", {}).get("fmt", "N/A")
                                inventory_long = quarterlyBalanceSheet.get("inventory", {}).get("longFmt", "N/A")
                                otherCurrentAssets = quarterlyBalanceSheet.get("otherCurrentAssets", {}).get("raw", "N/A")
                                otherCurrentAssets_fmt = quarterlyBalanceSheet.get("otherCurrentAssets", {}).get("fmt", "N/A")
                                otherCurrentAssets_long = quarterlyBalanceSheet.get("otherCurrentAssets", {}).get("longFmt", "N/A")
                                totalCurrentAssets = quarterlyBalanceSheet.get("totalCurrentAssets", {}).get("raw", "N/A")
                                totalCurrentAssets_fmt = quarterlyBalanceSheet.get("totalCurrentAssets", {}).get("fmt", "N/A")
                                totalCurrentAssets_long = quarterlyBalanceSheet.get("totalCurrentAssets", {}).get("longFmt", "N/A")
                                longTermInvestments = quarterlyBalanceSheet.get("longTermInvestments", {}).get("raw", "N/A")
                                longTermInvestments_fmt = quarterlyBalanceSheet.get("longTermInvestments", {}).get("fmt", "N/A")
                                longTermInvestments_long = quarterlyBalanceSheet.get("longTermInvestments", {}).get("longFmt", "N/A")
                                propertyPlantEquipment = quarterlyBalanceSheet.get("propertyPlantEquipment", {}).get("raw", "N/A")
                                propertyPlantEquipment_fmt = quarterlyBalanceSheet.get("propertyPlantEquipment", {}).get("fmt", "N/A")
                                propertyPlantEquipment_long = quarterlyBalanceSheet.get("propertyPlantEquipment", {}).get("longFmt", "N/A")
                                otherAssets = quarterlyBalanceSheet.get("otherAssets", {}).get("raw", "N/A")
                                otherAssets_fmt = quarterlyBalanceSheet.get("otherAssets", {}).get("fmt", "N/A")
                                otherAssets_long = quarterlyBalanceSheet.get("otherAssets", {}).get("longFmt", "N/A")
                                totalAssets = quarterlyBalanceSheet.get("totalAssets", {}).get("raw", "N/A")
                                totalAssets_fmt = quarterlyBalanceSheet.get("totalAssets", {}).get("fmt", "N/A")
                                totalAssets_long = quarterlyBalanceSheet.get("totalAssets", {}).get("longFmt", "N/A")
                                accountsPayable = quarterlyBalanceSheet.get("accountsPayable", {}).get("raw", "N/A")
                                accountsPayable_fmt = quarterlyBalanceSheet.get("accountsPayable", {}).get("fmt", "N/A")
                                accountsPayable_long = quarterlyBalanceSheet.get("accountsPayable", {}).get("longFmt", "N/A")
                                shortLongTermDebt = quarterlyBalanceSheet.get("shortLongTermDebt", {}).get("raw", "N/A")
                                shortLongTermDebt_fmt = quarterlyBalanceSheet.get("shortLongTermDebt", {}).get("fmt", "N/A")
                                shortLongTermDebt_long = quarterlyBalanceSheet.get("shortLongTermDebt", {}).get("longFmt", "N/A")
                                otherCurrentLiabilities = quarterlyBalanceSheet.get("otherCurrentLiab", {}).get("raw", "N/A")
                                otherCurrentLiabilities_fmt = quarterlyBalanceSheet.get("otherCurrentLiab", {}).get("fmt", "N/A")
                                otherCurrentLiabilities_long = quarterlyBalanceSheet.get("otherCurrentLiab", {}).get("longFmt", "N/A")
                                longTermDebt = quarterlyBalanceSheet.get("longTermDebt", {}).get("raw", "N/A")
                                longTermDebt_fmt = quarterlyBalanceSheet.get("longTermDebt", {}).get("fmt", "N/A")
                                longTermDebt_long = quarterlyBalanceSheet.get("longTermDebt", {}).get("longFmt", "N/A")
                                otherLiab = quarterlyBalanceSheet.get("otherLiab", {}).get("raw", "N/A")
                                otherLiab_fmt = quarterlyBalanceSheet.get("otherLiab", {}).get("fmt", "N/A")
                                otherLiab_long = quarterlyBalanceSheet.get("otherLiab", {}).get("longFmt", "N/A")
                                totalCurrentLiabilities = quarterlyBalanceSheet.get("totalCurrentLiabilities", {}).get("raw", "N/A")
                                totalCurrentLiabilities_fmt = quarterlyBalanceSheet.get("totalCurrentLiabilities", {}).get("fmt", "N/A")
                                totalCurrentLiabilities_long = quarterlyBalanceSheet.get("totalCurrentLiabilities", {}).get("longFmt", "N/A")
                                totalLiab = quarterlyBalanceSheet.get("totalLiab", {}).get("raw", "N/A")
                                totalLiab_fmt = quarterlyBalanceSheet.get("totalLiab", {}).get("fmt", "N/A")
                                totalLiab_long = quarterlyBalanceSheet.get("totalLiab", {}).get("longFmt", "N/A")
                                commonStock = quarterlyBalanceSheet.get("commonStock", {}).get("raw", "N/A")
                                commonStock_fmt = quarterlyBalanceSheet.get("commonStock", {}).get("fmt", "N/A")
                                commonStock_long = quarterlyBalanceSheet.get("commonStock", {}).get("longFmt", "N/A")
                                retainedEarnings = quarterlyBalanceSheet.get("retainedEarnings", {}).get("raw", "N/A")
                                retainedEarnings_fmt = quarterlyBalanceSheet.get("retainedEarnings", {}).get("fmt", "N/A")
                                retainedEarnings_long = quarterlyBalanceSheet.get("retainedEarnings", {}).get("longFmt", "N/A")
                                treasuryStock = quarterlyBalanceSheet.get("treasuryStock", {}).get("raw", "N/A")
                                treasuryStock_fmt = quarterlyBalanceSheet.get("treasuryStock", {}).get("fmt", "N/A")
                                treasuryStock_long = quarterlyBalanceSheet.get("treasuryStock", {}).get("longFmt", "N/A")
                                otherStockholderEquity = quarterlyBalanceSheet.get("otherStockholderEquity", {}).get("raw", "N/A")
                                otherStockholderEquity_fmt = quarterlyBalanceSheet.get("otherStockholderEquity", {}).get("fmt", "N/A")
                                otherStockholderEquity_long = quarterlyBalanceSheet.get("otherStockholderEquity", {}).get("longFmt", "N/A")
                                totalStockholderEquity = quarterlyBalanceSheet.get("totalStockholderEquity", {}).get("raw", "N/A")
                                totalStockholderEquity_fmt = quarterlyBalanceSheet.get("totalStockholderEquity", {}).get("fmt", "N/A")
                                totalStockholderEquity_long = quarterlyBalanceSheet.get("totalStockholderEquity", {}).get("longFmt", "N/A")
                                netTangibleAssets = quarterlyBalanceSheet.get("netTangibleAssets", {}).get("raw", "N/A")
                                netTangibleAssets_fmt = quarterlyBalanceSheet.get("netTangibleAssets", {}).get("fmt", "N/A")
                                netTangibleAssets_long = quarterlyBalanceSheet.get("netTangibleAssets", {}).get("longFmt", "N/A")
                                quarterlyBalanceSheet_data = {"endDate": endDate_fmt, "cash": cash_fmt, "shortTermInvestments": shortTermInvestments_fmt, "netReceivables": netReceivables_fmt, "inventory": inventory_fmt, "otherCurrentAssets": otherCurrentAssets_fmt, "totalCurrentAssets": totalCurrentAssets_fmt, "longTermInvestments": longTermInvestments_fmt, "propertyPlantEquipment": propertyPlantEquipment_fmt, "otherAssets": otherAssets_fmt, "totalAssets": totalAssets_fmt, "accountsPayable": accountsPayable_fmt, "shortLongTermDebt": shortLongTermDebt_fmt, "otherCurrentLiabilities": otherCurrentLiabilities_fmt, "longTermDebt": longTermDebt_fmt, "otherLiab": otherLiab_fmt, "totalCurrentLiabilities": totalCurrentLiabilities_fmt, "totalLiab": totalLiab_fmt, "commonStock": commonStock_fmt, "retainedEarnings": retainedEarnings_fmt, "treasuryStock": treasuryStock_fmt, "otherStockholderEquity": otherStockholderEquity_fmt, "totalStockholderEquity": totalStockholderEquity_fmt, "netTangibleAssets": netTangibleAssets_fmt}
                                quarterlyBalanceSheet_list.append(quarterlyBalanceSheet_data)

                def balanceSheetHistory():
                        # get balanceSheetHistory
                        balanceSheetHistory_list = []
                        balanceSheetHistory = response_data.get("balanceSheetHistory", {}).get("balanceSheetStatements", "N/A")
                        for balanceSheet in balanceSheetHistory:
                                endDate = balanceSheet.get("endDate", {}).get("raw", "N/A")
                                endDate_fmt = balanceSheet.get("endDate", {}).get("fmt", "N/A")
                                cash = balanceSheet.get("cash", {}).get("raw", "N/A")
                                cash_fmt = balanceSheet.get("cash", {}).get("fmt", "N/A")
                                cash_long = balanceSheet.get("cash", {}).get("longFmt", "N/A")
                                shortTermInvestments = balanceSheet.get("shortTermInvestments", {}).get("raw", "N/A")
                                shortTermInvestments_fmt = balanceSheet.get("shortTermInvestments", {}).get("fmt", "N/A")
                                shortTermInvestments_long = balanceSheet.get("shortTermInvestments", {}).get("longFmt", "N/A")
                                netReceivables = balanceSheet.get("netReceivables", {}).get("raw", "N/A")
                                netReceivables_fmt = balanceSheet.get("netReceivables", {}).get("fmt", "N/A")
                                netReceivables_long = balanceSheet.get("netReceivables", {}).get("longFmt", "N/A")
                                inventory = balanceSheet.get("inventory", {}).get("raw", "N/A")
                                inventory_fmt = balanceSheet.get("inventory", {}).get("fmt", "N/A")
                                inventory_long = balanceSheet.get("inventory", {}).get("longFmt", "N/A")
                                otherCurrentAssets = balanceSheet.get("otherCurrentAssets", {}).get("raw", "N/A")
                                otherCurrentAssets_fmt = balanceSheet.get("otherCurrentAssets", {}).get("fmt", "N/A")
                                otherCurrentAssets_long = balanceSheet.get("otherCurrentAssets", {}).get("longFmt", "N/A")
                                totalCurrentAssets = balanceSheet.get("totalCurrentAssets", {}).get("raw", "N/A")
                                totalCurrentAssets_fmt = balanceSheet.get("totalCurrentAssets", {}).get("fmt", "N/A")
                                totalCurrentAssets_long = balanceSheet.get("totalCurrentAssets", {}).get("longFmt", "N/A")
                                longTermInvestments = balanceSheet.get("longTermInvestments", {}).get("raw", "N/A")
                                longTermInvestments_fmt = balanceSheet.get("longTermInvestments", {}).get("fmt", "N/A")
                                longTermInvestments_long = balanceSheet.get("longTermInvestments", {}).get("longFmt", "N/A")
                                propertyPlantEquipment = balanceSheet.get("propertyPlantEquipment", {}).get("raw", "N/A")
                                propertyPlantEquipment_fmt = balanceSheet.get("propertyPlantEquipment", {}).get("fmt", "N/A")
                                propertyPlantEquipment_long = balanceSheet.get("propertyPlantEquipment", {}).get("longFmt", "N/A")
                                otherAssets = balanceSheet.get("otherAssets", {}).get("raw", "N/A")
                                otherAssets_fmt = balanceSheet.get("otherAssets", {}).get("fmt", "N/A")
                                otherAssets_long = balanceSheet.get("otherAssets", {}).get("longFmt", "N/A")
                                totalAssets = balanceSheet.get("totalAssets", {}).get("raw", "N/A")
                                totalAssets_fmt = balanceSheet.get("totalAssets", {}).get("fmt", "N/A")
                                totalAssets_long = balanceSheet.get("totalAssets", {}).get("longFmt", "N/A")
                                accountsPayable = balanceSheet.get("accountsPayable", {}).get("raw", "N/A")
                                accountsPayable_fmt = balanceSheet.get("accountsPayable", {}).get("fmt", "N/A")
                                accountsPayable_long = balanceSheet.get("accountsPayable", {}).get("longFmt", "N/A")
                                shortLongTermDebt = balanceSheet.get("shortLongTermDebt", {}).get("raw", "N/A")
                                shortLongTermDebt_fmt = balanceSheet.get("shortLongTermDebt", {}).get("fmt", "N/A")
                                shortLongTermDebt_long = balanceSheet.get("shortLongTermDebt", {}).get("longFmt", "N/A")
                                otherCurrentLiab = balanceSheet.get("otherCurrentLiab", {}).get("raw", "N/A")
                                otherCurrentLiab_fmt = balanceSheet.get("otherCurrentLiab", {}).get("fmt", "N/A")
                                otherCurrentLiab_long = balanceSheet.get("otherCurrentLiab", {}).get("longFmt", "N/A")
                                totalCurrentLiabilities = balanceSheet.get("totalCurrentLiabilities", {}).get("raw", "N/A")
                                totalCurrentLiabilities_fmt = balanceSheet.get("totalCurrentLiabilities", {}).get("fmt", "N/A")
                                totalCurrentLiabilities_long = balanceSheet.get("totalCurrentLiabilities", {}).get("longFmt", "N/A")
                                totalLiab = balanceSheet.get("totalLiab", {}).get("raw", "N/A")
                                totalLiab_fmt = balanceSheet.get("totalLiab", {}).get("fmt", "N/A")
                                totalLiab_long = balanceSheet.get("totalLiab", {}).get("longFmt", "N/A")
                                commonStock = balanceSheet.get("commonStock", {}).get("raw", "N/A")
                                commonStock_fmt = balanceSheet.get("commonStock", {}).get("fmt", "N/A")
                                commonStock_long = balanceSheet.get("commonStock", {}).get("longFmt", "N/A")
                                retainedEarnings = balanceSheet.get("retainedEarnings", {}).get("raw", "N/A")
                                retainedEarnings_fmt = balanceSheet.get("retainedEarnings", {}).get("fmt", "N/A")
                                retainedEarnings_long = balanceSheet.get("retainedEarnings", {}).get("longFmt", "N/A")
                                treasuryStock = balanceSheet.get("treasuryStock", {}).get("raw", "N/A")
                                treasuryStock_fmt = balanceSheet.get("treasuryStock", {}).get("fmt", "N/A")
                                treasuryStock_long = balanceSheet.get("treasuryStock", {}).get("longFmt", "N/A")
                                otherStockholderEquity = balanceSheet.get("otherStockholderEquity", {}).get("raw", "N/A")
                                otherStockholderEquity_fmt = balanceSheet.get("otherStockholderEquity", {}).get("fmt", "N/A")
                                otherStockholderEquity_long = balanceSheet.get("otherStockholderEquity", {}).get("longFmt", "N/A")
                                totalStockholderEquity = balanceSheet.get("totalStockholderEquity", {}).get("raw", "N/A")
                                totalStockholderEquity_fmt = balanceSheet.get("totalStockholderEquity", {}).get("fmt", "N/A")
                                totalStockholderEquity_long = balanceSheet.get("totalStockholderEquity", {}).get("longFmt", "N/A")
                                netTangibleAssets = balanceSheet.get("netTangibleAssets", {}).get("raw", "N/A")
                                netTangibleAssets_fmt = balanceSheet.get("netTangibleAssets", {}).get("fmt", "N/A")
                                netTangibleAssets_long = balanceSheet.get("netTangibleAssets", {}).get("longFmt", "N/A")
                                balanceSheetHistory_data = {"endDate": endDate_fmt, "cash": cash_fmt, "shortTermInvestments": shortTermInvestments_fmt, "netReceivables": netReceivables_fmt, "inventory": inventory_fmt, "otherCurrentAssets": otherCurrentAssets_fmt, "totalCurrentAssets": totalCurrentAssets_fmt, "longTermInvestments": longTermInvestments_fmt, "propertyPlantEquipment": propertyPlantEquipment_fmt, "otherAssets": otherAssets_fmt, "totalAssets": totalAssets_fmt, "accountsPayable": accountsPayable_fmt, "shortLongTermDebt": shortLongTermDebt_fmt, "otherCurrentLiab": otherCurrentLiab_fmt, "totalCurrentLiabilities": totalCurrentLiabilities_fmt, "totalLiab": totalLiab_fmt, "commonStock": commonStock_fmt, "retainedEarnings": retainedEarnings_fmt, "treasuryStock": treasuryStock_fmt, "otherStockholderEquity": otherStockholderEquity_fmt, "totalStockholderEquity": totalStockholderEquity_fmt, "netTangibleAssets": netTangibleAssets_fmt}
                                balanceSheetHistory_list.append(balanceSheetHistory_data)

                        def calendarEvents():
                                calendarEvents = response_data.get("calendarEvents", "N/A")
                                earnings = calendarEvents.get("earnings", "N/A")
                                exDividendDate = earnings.get("exDividendDate", "N/A")
                                dividendDate = earnings.get("dividendDate", "N/A")

                                earndate = earnings.get("earningsDate", "N/A")
                                # earnings
                                for date in earndate:
                                        earningsDate = date.get("raw", "N/A")
                                        earningsDate_fmt = date.get("fmt", "N/A")
                                earningsAverage = earnings.get("earningsAverage", "N/A").get("raw", "N/A")
                                earningsAverage_fmt = earnings.get("earningsAverage", "N/A").get("fmt", "N/A")
                                earningsLow = earnings.get("earningsLow", "N/A").get("raw", "N/A")
                                earningsLow_fmt = earnings.get("earningsLow", "N/A").get("fmt", "N/A")
                                earningsHigh = earnings.get("earningsHigh", "N/A").get("raw", "N/A")
                                earningsHigh_fmt = earnings.get("earningsHigh", "N/A").get("fmt", "N/A")
                                revenueAverage = earnings.get("revenueAverage", "N/A").get("raw", "N/A")
                                revenueAverage_fmt = earnings.get("revenueAverage", "N/A").get("fmt", "N/A")
                                revenueLow = earnings.get("revenueLow", "N/A").get("raw", "N/A")
                                revenueLow_fmt = earnings.get("revenueLow", "N/A").get("fmt", "N/A")
                                revenueHigh = earnings.get("revenueHigh", "N/A").get("raw", "N/A")
                                revenueHigh_fmt = earnings.get("revenueHigh", "N/A").get("fmt", "N/A")
                                calendarEvents_data = {"exDividendDate": exDividendDate, "dividendDate": dividendDate, "earningsDate": earndate, "earningsAverage": earningsAverage_fmt, "earningsLow": earningsLow_fmt, "earningsHigh": earningsHigh_fmt, "revenueAverage": revenueAverage_fmt, "revenueLow": revenueLow_fmt, "revenueHigh": revenueHigh_fmt}



# asset-profile (good)
# income-statement (good)
# balance-sheet (good)
# cashflow-statement, (good)
# default-key-statistics (good)
# calendar-events, (incomplete)
# sec-filings, (incomplete)
# upgrade-downgrade-history, (incomplete)
# institution-ownership, (good)
# fund-ownership (good)
# insider-transactions, (incomplete)
# insider-holders, (good)
# earnings-history (incomplete)
